    ...
    public partial class SeedMoreProducts : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "ImageUrl", "Price" },
                values: new object[] { "The Hitchhiker's Guide to the Galaxy[a][b] is a comedy science fiction franchise created by Douglas Adams. Originally a 1978 radio comedy broadcast on BBC Radio 4, it was later adapted to other formats, including novels, stage shows, comic books, a 1981 TV series, a 1984 text adventure game, and 2005 feature film.", "https://en.wikipedia.org/wiki/File:H2G2_UK_front_cover.jpg", 9.99m });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price" },
                values: new object[] { 3, "Nineteen Eighty-Four (also published as 1984) is a dystopian social science fiction novel and cautionary tale by English writer George Orwell.", "https://en.wikipedia.org/wiki/File:1984_first_edition_cover.jpg", 6.99m });
        }
    }
}
